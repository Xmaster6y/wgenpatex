...
parser.add_argument('-nmax', '--n_iter_max', type=int, default=1000, help="max iterations of the algorithm(default: 1000)")
parser.add_argument('-npsi', '--n_iter_psi', type=int, default=100, help="max iterations for psi (default: 100)")
...
parser.add_argument('-sc', '--scales', type=int, default=3, help="number of scales used (default: 4)")
...
synth_img = wgenpatex.optim_patching(args)
